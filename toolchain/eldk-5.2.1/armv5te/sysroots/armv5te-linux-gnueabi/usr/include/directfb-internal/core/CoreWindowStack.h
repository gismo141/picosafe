...
typedef enum {
    ...
    _CoreWindowStack_CursorEnable = 2,
    _CoreWindowStack_CursorSetShape = 3,
    _CoreWindowStack_CursorSetOpacity = 4,
    _CoreWindowStack_CursorSetAcceleration = 5,
    _CoreWindowStack_CursorWarp = 6,
    _CoreWindowStack_CursorGetPosition = 7,
    _CoreWindowStack_BackgroundSetMode = 8,
    _CoreWindowStack_BackgroundSetImage = 9,
    _CoreWindowStack_BackgroundSetColor = 10,
    _CoreWindowStack_BackgroundSetColorIndex = 11,
} CoreWindowStackCall;
