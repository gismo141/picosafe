...
Currently available applets include:
	...
	[, [[, adjtimex, ash, awk, basename, beep, blockdev, cat, chattr,
	chgrp, chmod, chown, chroot, cp, cttyhack, dd, depmod, devmem, df,
	dhcprelay, dmesg, dnsd, du, dumpleases, echo, egrep, env, expand,
	expr, false, fgrep, free, fsck, fuser, grep, halt, head, httpd, id,
	ifconfig, ifdown, ifenslave, ifplugd, ifup, inetd, insmod, iostat,
	ip, ipaddr, iplink, iproute, iprule, iptunnel, kill, killall,
	killall5, less, ln, losetup, ls, lsattr, lsmod, lsof, lsusb, mkdir,
	mkdosfs, mkfifo, mkfs.vfat, mknod, mkswap, modinfo, modprobe, mount,
	mv, nanddump, nandwrite, nc, netstat, nice, nohup, nslookup, pgrep,
	pidof, ping, ping6, pkill, poweroff, printenv, ps, pstree, pwd,
	readlink, realpath, reboot, renice, rm, rmdir, rmmod, route, seq,
	setserial, sh, sleep, strings, stty, swapoff, swapon, switch_root,
	sync, sysctl, tac, tail, tee, telnet, test, time, timeout, touch,
	tr, true, tty, tune2fs, ubiattach, ubidetach, ubimkvol, ubirmvol,
	ubirsvol, ubiupdatevol, udhcpd, umount, uname, unexpand, uniq,
	usleep, watchdog, wc, wget, whoami, whois, yes
