...
class Secure 
{
  ...
  function GetGET($name,$rule="alpha+digit+specialchars",$maxlength="",$sqlcheckoff="")
  {
    //return $this->Syntax($this->GET[$name],$rule,$maxlength,$sqlcheckoff);
    return $this->GET[$name];
  }

  function GetPOST($name,$rule="alpha+digit+specialchars",$maxlength="",$sqlcheckoff="")
  {
    //return $this->POST[$name];
    return 'Aaa';//$_POST[$name];
