...
<head>
  <title>picosafe PHProxy</title>
  <link rel="stylesheet" type="text/css" href="style.css" title="Default Theme" media="all" />
</head>
<body onload="document.getElementById('address_box').focus()" style="background-color: #088599">
<div id="container">
  <h1 id="title"><img src="../themes/fredgui/images/picosafe.png"></h1>
<?php
